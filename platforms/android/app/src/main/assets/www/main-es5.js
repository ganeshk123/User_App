...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        value: function submit() {
          ...
          this.api.post('rating/save', param).subscribe(function (data) {
            ...
            if (data && data.status === 200) {
              ...
              _this9.api.post('stores/editByUid', storeParam).subscribe(function (stores) {
    ...
    var VerifyPage = /*#__PURE__*/function () {
      ...
      _createClass(VerifyPage, [{
        ...
        value: function sendOTP() {
          ...
          var message = 'Your Contactless Shopping app verification code : ';
          var param = {
            msg: message,
            to: this.mobile
          };
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/admin/Desktop/Grocery Delivery/ionic5GroceryeeAppFull_V7/App_code/User_app/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
